...
<div class="content-body">
    ...
    @include('includes.dashboard.full')
    @else
    @include('includes.dashboard.simple')
    @endif
</div>
@endsection
@section('extra')
...
@push('js')
<!-- Dashboard 1 -->
<script src="{{ getFileVersion('/assets/js/dashboard/dashboard-1.js') }}"></script>
<script src="{{ getFileVersion('/assets/vendor/draggable/draggable.js') }}"></script>


<!-- tagify -->
<script src="{{ getFileVersion('/assets/vendor/tagify/dist/tagify.js') }}"></script>

<!-- Apex Chart -->

<script src="{{ getFileVersion('/assets/vendor/bootstrap-datetimepicker/js/moment.js') }}"></script>
<script src="{{ getFileVersion('/assets/vendor/bootstrap-datetimepicker/js/bootstrap-datetimepicker.min.js') }}"></script>


<!-- Vectormap -->
<script src="{{ getFileVersion('/assets/vendor/jqvmap/js/jquery.vmap.min.js') }}"></script>
<script src="{{ getFileVersion('/assets/vendor/jqvmap/js/jquery.vmap.world.js') }}"></script>
<script src="{{ getFileVersion('/assets/vendor/jqvmap/js/jquery.vmap.usa.js') }}"></script>
@endpush