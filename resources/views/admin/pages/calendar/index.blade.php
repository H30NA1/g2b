...
@push('css')
<link href="{{ getFileVersion('/assets/admin/plugins/custom/fullcalendar/fullcalendar.bundle.css') }}" rel="stylesheet" type="text/css" />
@endpush
...
<script src="{{ getFileVersion('/assets/admin/plugins/custom/fullcalendar/fullcalendar.bundle.js') }}"></script>
<script src="{{ getFileVersion('/assets/admin/js/custom/apps/calendar/calendar.js') }}"></script>
