        ...
        <div class="row">
            ...
            <div class="col-xl-12">
                <div class="row">
                    ...
                    <form action="{{ route('web.employees.roles.update', ['id' => $role['user_id']]) }}" method="POST">
                        @csrf
                                            ...
                                            <div class="d-flex align-items-center justify-content-between">
                                                ...
                                                <div class="d-flex">
                                                    ...
                                                    <div class="form-check custom-checkbox mb-3 checkbox-warning">
                                                        <input type="hidden" name="role[{{ $route['route'] }}][{{ $key }}]" value="0">
                                                        <input type="checkbox" name="role[{{ $route['route'] }}][{{ $key }}]" class="form-check-input" id="customCheckBox1" value="1" {{ $method == 1 ? 'checked' : '' }}>
                                                    </div>
                                                    @endforeach
                                                </div>
                                            </div>
                        ...
                        <div class="card-footer fixed-bottom custom-fixed-bottom">
                            ...
                            <a href="{{ route('web.employees.roles.refresh', ['id' => $role['user_id']]) }}" class="btn btn-secondary" style="margin-left: 20px;">Refresh</a>
                        </div>
                    </form>
                </div>
