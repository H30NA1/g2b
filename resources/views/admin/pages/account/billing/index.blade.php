                        ...
                        <div class="d-flex flex-stack flex-grow-1">
                            ...
                            <div class="fw-semibold">
                                ...
                                <div class="fs-6 text-gray-700">Your payment was declined. To start using tools, please
                                    <a href="#" class="fw-bold" data-bs-toggle="modal" data-bs-target="#kt_modal_new_card">Add Payment Method</a>.
                                </div>
                            </div>
                            <!--end::Content-->
                        </div>
                            ...
                            <div class="col-xl-6" data-kt-billing-element="card">
                                ...
                                <div class="card card-dashed h-xl-100 flex-row flex-stack flex-wrap p-6">
                                    ...
                                    <div class="d-flex flex-column py-2">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <!--begin::Icon-->
                                            <img src="{{ getFileVersion('/assets/admin/media/svg/card-logos/visa.svg') }}" alt="" class="me-4" />
                                            <!--end::Icon-->
                                            <!--begin::Details-->
                                            <div>
                            ...
                            <div class="col-xl-6" data-kt-billing-element="card">
                                ...
                                <div class="card card-dashed h-xl-100 flex-row flex-stack flex-wrap p-6">
                                    ...
                                    <div class="d-flex flex-column py-2">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <!--begin::Icon-->
                                            <img src="{{ getFileVersion('/assets/admin/media/svg/card-logos/american-express.svg') }}" alt="" class="me-4" />
                                            <!--end::Icon-->
                                            <!--begin::Details-->
                                            <div>
                            ...
                            <div class="col-xl-6" data-kt-billing-element="card">
                                ...
                                <div class="card card-dashed h-xl-100 flex-row flex-stack flex-wrap p-6">
                                    ...
                                    <div class="d-flex flex-column py-2">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <!--begin::Icon-->
                                            <img src="{{ getFileVersion('/assets/admin/media/svg/card-logos/mastercard.svg') }}" alt="" class="me-4" />
                                            <!--end::Icon-->
                                            <!--begin::Details-->
                                            <div>
