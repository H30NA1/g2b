                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="pe-0">
                                            <div class="avatar-list avatar-list-stacked">
                                                <img src="{{ getFileVersion('/assets/admin/images/contacts/pic1.jpg') }}" class="avatar rounded-circle" alt="">
                                                <img src="{{ getFileVersion('/assets/admin/images/contacts/pic777.jpg') }}" class="avatar rounded-circle" alt="">
                                                <img src="{{ getFileVersion('/assets/admin/images/contacts/pic666.jpg') }}" class="avatar rounded-circle" alt="">
                                            </div>
                                        </td>
                                        <td class="pe-0">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="{{ getFileVersion('/assets/admin/images/contacts/pic2.jpg') }}" class="avatar rounded-circle" alt="">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="{{ getFileVersion('/assets/admin/images/contacts/pic888.jpg') }}" class="avatar rounded-circle" alt="">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="{{ getFileVersion('/assets/admin/images/contacts/pic999.jpg') }}" class="avatar rounded-circle" alt="">
                                                <p class="mb-0 ms-2">Elijah James</p>
                                            </div>
                                        </td>
                                        <td class="pe-0">
                            ...
                            <div class="col-xl-4 active-country dz-scroll">
                                <div class="">
                                    <div class="country-list">
                                        <img src="{{ getFileVersion('/assets/admin/images/country/india.png') }}" alt="">
                                        <div class="progress-box mt-0">
                                            <div class="d-flex justify-content-between">
                                    ...
                                    <div class="country-list">
                                        <img src="{{ getFileVersion('/assets/admin/images/country/canada.png') }}" alt="">
                                        <div class="progress-box mt-0">
                                            <div class="d-flex justify-content-between">
                                    ...
                                    <div class="country-list">
                                        <img src="{{ getFileVersion('/assets/admin/images/country/russia.png') }}" alt="">
                                        <div class="progress-box mt-0">
                                            <div class="d-flex justify-content-between">
                                    ...
                                    <div class="country-list">
                                        <img src="{{ getFileVersion('/assets/admin/images/country/uk.png') }}" alt="">
                                        <div class="progress-box mt-0">
                                            <div class="d-flex justify-content-between">
                                    ...
                                    <div class="country-list">
                                        <img src="{{ getFileVersion('/assets/admin/images/country/aus.png') }}" alt="">
                                        <div class="progress-box mt-0">
                                            <div class="d-flex justify-content-between">
                                    ...
                                    <div class="country-list">
                                        <img src="{{ getFileVersion('/assets/admin/images/country/usa.png') }}" alt="">
                                        <div class="progress-box mt-0">
                                            <div class="d-flex justify-content-between">
                                    ...
                                    <div class="country-list">
                                        <img src="{{ getFileVersion('/assets/admin/images/country/pak.png') }}" alt="">
                                        <div class="progress-box mt-0">
                                            <div class="d-flex justify-content-between">
                                    ...
                                    <div class="country-list">
                                        <img src="{{ getFileVersion('/assets/admin/images/country/germany.png') }}" alt="">
                                        <div class="progress-box mt-0">
                                            <div class="d-flex justify-content-between">
                                    ...
                                    <div class="country-list">
                                        <img src="{{ getFileVersion('/assets/admin/images/country/uae.png') }}" alt="">
                                        <div class="progress-box mt-0">
                                            <div class="d-flex justify-content-between">
                                    ...
                                    <div class="country-list">
                                        <img src="{{ getFileVersion('/assets/admin/images/country/china.png') }}" alt="">
                                        <div class="progress-box mt-0">
                                            <div class="d-flex justify-content-between">
                            ...
                            <table id="product-tbl" class="table ">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="products">
                                                <img src="{{ getFileVersion('/assets/admin/images/contacts/d1.jpg') }}" class="avatar avatar-md" alt="">
                                                <div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="products">
                                                <img src="{{ getFileVersion('/assets/admin/images/contacts/d2.jpg') }}" class="avatar avatar-md" alt="">
                                                <div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="products">
                                                <img src="{{ getFileVersion('/assets/admin/images/contacts/d3.jpg') }}" class="avatar avatar-md" alt="">
                                                <div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="products">
                                                <img src="{{ getFileVersion('/assets/admin/images/contacts/d4.jpg') }}" class="avatar avatar-md" alt="">
                                                <div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="products">
                                                <img src="{{ getFileVersion('/assets/admin/images/contacts/d5.jpg') }}" class="avatar avatar-md" alt="">
                                                <div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="products">
                                                <img src="{{ getFileVersion('/assets/admin/images/contacts/d6.jpg') }}" class="avatar avatar-md" alt="">
                                                <div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="products">
                                                <img src="{{ getFileVersion('/assets/admin/images/contacts/d7.jpg') }}" class="avatar avatar-md" alt="">
                                                <div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="products">
                                                <img src="{{ getFileVersion('/assets/admin/images/contacts/d8.jpg') }}" class="avatar avatar-md" alt="">
                                                <div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="products">
                                                <img src="{{ getFileVersion('/assets/admin/images/contacts/d14.jpg') }}" class="avatar avatar-md" alt="">
                                                <div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="products">
                                                <img src="{{ getFileVersion('/assets/admin/images/contacts/d13.jpg') }}" class="avatar avatar-md" alt="">
                                                <div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="products">
                                                <img src="{{ getFileVersion('/assets/admin/images/contacts/d9.jpg') }}" class="avatar avatar-md" alt="">
                                                <div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="products">
                                                <img src="{{ getFileVersion('/assets/admin/images/contacts/d10.jpg') }}" class="avatar avatar-md" alt="">
                                                <div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="products">
                                                <img src="{{ getFileVersion('/assets/admin/images/contacts/d11.jpg') }}" class="avatar avatar-md" alt="">
                                                <div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="products">
                                                <img src="{{ getFileVersion('/assets/admin/images/contacts/d12.jpg') }}" class="avatar avatar-md" alt="">
                                                <div>
...
@push('js')
<!-- Dashboard 1 -->
<script src="{{ getFileVersion('/assets/admin/js/dashboard/dashboard-1.js') }}"></script>
<script src="{{ getFileVersion('/assets/admin/vendor/draggable/draggable.js') }}"></script>
...
<!-- Vectormap -->
<script src="{{ getFileVersion('/assets/admin/vendor/jqvmap/js/jquery.vmap.min.js') }}"></script>
<script src="{{ getFileVersion('/assets/admin/vendor/jqvmap/js/jquery.vmap.world.js') }}"></script>
<script src="{{ getFileVersion('/assets/admin/vendor/jqvmap/js/jquery.vmap.usa.js') }}"></script>
@endpush