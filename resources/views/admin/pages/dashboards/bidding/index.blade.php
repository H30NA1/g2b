            ...
            <div class="row g-5 g-xl-10 mb-5 mb-xl-10">
                        ...
                        <div class="card-body py-9">
                            ...
                            <div class="row gx-9 h-100">
                                ...
                                <div class="col-sm-6 mb-10 mb-sm-0">
                                    <!--begin::Overlay-->
                                    <a class="d-block overlay h-100" data-fslightbox="lightbox-hot-sales" href="{{ getFileVersion('/assets/admin/media/stock/600x600/img-42.jpg') }}">
                                        <!--begin::Image-->
                                        <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-200px h-100" style="background-image:url('{{ getFileVersion('/assets/admin/media/stock/600x600/img-42.jpg') }}')"></div>
                                        <!--end::Image-->
                                        <!--begin::Action-->
                ...
                <div class="col-sm-6 col-xxl-3">
                    ...
                    <div class="card card-flush h-xl-100">
                        ...
                        <div class="card-body text-center pb-5">
                            <!--begin::Overlay-->
                            <a class="d-block overlay" data-fslightbox="lightbox-hot-sales" href="{{ getFileVersion('/assets/admin/media/stock/600x600/img-39.jpg') }}">
                                <!--begin::Image-->
                                <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded mb-7" style="height: 266px;background-image:url('{{ getFileVersion('/assets/admin/media/stock/600x600/img-39.jpg') }}')"></div>
                                <!--end::Image-->
                                <!--begin::Action-->
                                <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                                    <i class="ki-outline ki-eye fs-3x text-white"></i>
                ...
                <div class="col-sm-6 col-xxl-3">
                    ...
                    <div class="card card-flush h-xl-100">
                        ...
                        <div class="card-body text-center pb-5">
                            <!--begin::Overlay-->
                            <a class="d-block overlay" data-fslightbox="lightbox-hot-sales" href="{{ getFileVersion('/assets/admin/media/stock/600x600/img-47.jpg') }}">
                                <!--begin::Image-->
                                <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded mb-7" style="height: 266px;background-image:url('{{ getFileVersion('/assets/admin/media/stock/600x600/img-47.jpg') }}')"></div>
                                <!--end::Image-->
                                <!--begin::Action-->
                                <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                                    <i class="ki-outline ki-eye fs-3x text-white"></i>
                                    ...
                                    <tbody>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="symbol symbol-50px me-3">
                                                        <img src="{{ getFileVersion('/assets/admin/media/stock/600x600/img-49.jpg') }}" class="" alt="" />
                                                    </div>
                                            ...
                                            <td class="pe-0">
                                                <div class="d-flex align-items-center justify-content-end">
                                                    <div class="symbol symbol-30px me-3">
                                                        <img src="{{ getFileVersion('/assets/admin/media/avatars/300-13.jpg') }}" class="" alt="" />
                                                    </div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="symbol symbol-50px me-3">
                                                        <img src="{{ getFileVersion('/assets/admin/media/stock/600x600/img-43.jpg') }}" class="" alt="" />
                                                    </div>
                                                    <div class="d-flex justify-content-start flex-column">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="symbol symbol-50px me-3">
                                                        <img src="{{ getFileVersion('/assets/admin/media/stock/600x600/img-46.jpg') }}" class="" alt="" />
                                                    </div>
                                                    <div class="d-flex justify-content-start flex-column">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="symbol symbol-50px me-3">
                                                        <img src="{{ getFileVersion('/assets/admin/media/stock/600x600/img-54.jpg') }}" class="" alt="" />
                                                    </div>
                                                    <div class="d-flex justify-content-start flex-column">
                                            ...
                                            <td class="pe-0">
                                                <div class="d-flex align-items-center justify-content-end">
                                                    <div class="symbol symbol-30px me-3">
                                                        <img src="{{ getFileVersion('/assets/admin/media/avatars/300-10.jpg') }}" class="" alt="" />
                                                    </div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="symbol symbol-50px me-3">
                                                        <img src="{{ getFileVersion('/assets/admin/media/stock/600x600/img-45.jpg') }}" class="" alt="" />
                                                    </div>
                                                    <div class="d-flex justify-content-start flex-column">
                            ...
                            <div class="">
                                ...
                                <div class="d-flex flex-stack">
                                    ...
                                    <div class="d-flex align-items-center me-5">
                                        <!--begin::Flag-->
                                        <img src="{{ getFileVersion('/assets/admin/media/svg/brand-logos/atica.svg') }}" class="me-4 w-30px" style="border-radius: 4px" alt="" />
                                        <!--end::Flag-->
                                        <!--begin::Content-->
                                        <div class="me-5">
                                            <!--begin::Title-->
                                ...
                                <div class="d-flex flex-stack">
                                    ...
                                    <div class="d-flex align-items-center me-5">
                                        <!--begin::Flag-->
                                        <img src="{{ getFileVersion('/assets/admin/media/svg/brand-logos/telegram-2.svg') }}" class="me-4 w-30px" style="border-radius: 4px" alt="" />
                                        <!--end::Flag-->
                                        <!--begin::Content-->
                                        <div class="me-5">
                                            <!--begin::Title-->
                                ...
                                <div class="d-flex flex-stack">
                                    ...
                                    <div class="d-flex align-items-center me-5">
                                        <!--begin::Flag-->
                                        <img src="{{ getFileVersion('/assets/admin/media/svg/brand-logos/balloon.svg') }}" class="me-4 w-30px" style="border-radius: 4px" alt="" />
                                        <!--end::Flag-->
                                        <!--begin::Content-->
                                        <div class="me-5">
                                            <!--begin::Title-->
                                ...
                                <div class="d-flex flex-stack">
                                    ...
                                    <div class="d-flex align-items-center me-5">
                                        <!--begin::Flag-->
                                        <img src="{{ getFileVersion('/assets/admin/media/svg/brand-logos/kickstarter.svg') }}" class="me-4 w-30px" style="border-radius: 4px" alt="" />
                                        <!--end::Flag-->
                                        <!--begin::Content-->
                                        <div class="me-5">
                                            <!--begin::Title-->
                                ...
                                <div class="d-flex flex-stack">
                                    ...
                                    <div class="d-flex align-items-center me-5">
                                        <!--begin::Flag-->
                                        <img src="{{ getFileVersion('/assets/admin/media/svg/brand-logos/vimeo.svg') }}" class="me-4 w-30px" style="border-radius: 4px" alt="" />
                                        <!--end::Flag-->
                                        <!--begin::Content-->
                                        <div class="me-5">
                                            <!--begin::Title-->
                                ...
                                <div class="d-flex flex-stack">
                                    ...
                                    <div class="d-flex align-items-center me-5">
                                        <!--begin::Flag-->
                                        <img src="{{ getFileVersion('/assets/admin/media/svg/brand-logos/plurk.svg') }}" class="me-4 w-30px" style="border-radius: 4px" alt="" />
                                        <!--end::Flag-->
                                        <!--begin::Content-->
                                        <div class="me-5">
                                            <!--begin::Title-->
