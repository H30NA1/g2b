        ...
        <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex align-items-stretch">
            ...
            <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
                ...
                <div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex flex-column justify-content-center text-gray-900 fw-bold fs-3 m-0">Social Dashboard</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                ...
                <div class="col-sm-6 col-xl-2 mb-xl-10">
                    ...
                    <div class="card h-lg-100">
                        ...
                        <div class="card-body d-flex justify-content-between align-items-start flex-column">
                            <!--begin::Icon-->
                            <div class="m-0">
                                <img src="{{ getFileVersion('/assets/admin/media/svg/brand-logos/instagram-2-1.svg') }}" class="w-35px" alt="" />
                            </div>
                            <!--end::Icon-->
                            <!--begin::Section-->
                ...
                <div class="col-sm-6 col-xl-2 mb-xl-10">
                    ...
                    <div class="card h-lg-100">
                        ...
                        <div class="card-body d-flex justify-content-between align-items-start flex-column">
                            <!--begin::Icon-->
                            <div class="m-0">
                                <img src="{{ getFileVersion('/assets/admin/media/svg/brand-logos/facebook-3.svg') }}" class="w-35px" alt="" />
                            </div>
                            <!--end::Icon-->
                            <!--begin::Section-->
                            <div class="d-flex flex-column my-7">
                ...
                <div class="col-sm-6 col-xl-2 mb-xl-10">
                    ...
                    <div class="card h-lg-100">
                        ...
                        <div class="card-body d-flex justify-content-between align-items-start flex-column">
                            <!--begin::Icon-->
                            <div class="m-0">
                                <img src="{{ getFileVersion('/assets/admin/media/svg/brand-logos/dribbble-icon-1.svg') }}" class="w-35px" alt="" />
                            </div>
                            <!--end::Icon-->
                            <!--begin::Section-->
                            <div class="d-flex flex-column my-7">
                ...
                <div class="col-sm-6 col-xl-2 mb-xl-10">
                    ...
                    <div class="card h-lg-100">
                        ...
                        <div class="card-body d-flex justify-content-between align-items-start flex-column">
                            <!--begin::Icon-->
                            <div class="m-0">
                                <img src="{{ getFileVersion('/assets/admin/media/svg/brand-logos/twitter.svg') }}" class="w-35px" alt="" />
                            </div>
                            <!--end::Icon-->
                            <!--begin::Section-->
                            <div class="d-flex flex-column my-7">
                        ...
                        <div class="card-body pt-1">
                            ...
                            <div class="d-flex flex-stack flex-wrap gap-4">
                                ...
                                <div class="d-flex align-items-center gap-4">
                                    ...
                                    <!--begin::Menu 1-->
                                    <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_65a116530394d">
                                        <!--begin::Header-->
                                        <div class="px-7 py-5">
                                        ...
                                        <div class="px-7 py-5">
                                            ...
                                            <div class="mb-10">
                                                ...
                                                <!--begin::Input-->
                                                <div>
                                                    <select class="form-select form-select-solid" multiple="multiple" data-kt-select2="true" data-close-on-select="false" data-placeholder="Select option" data-dropdown-parent="#kt_menu_65a116530394d" data-allow-clear="true">
                                                        <option></option>
                        ...
                        <div class="card-body d-flex justify-content-between flex-column p-0">
                            ...
                            <div class="mb-5 px-9">
                                ...
                                <div class="d-flex flex-stack">
                                    ...
                                    <div class="d-flex align-items-center me-3">
                                        <!--begin::Icon-->
                                        <img src="{{ getFileVersion('/assets/admin/media/svg/brand-logos/invision.svg') }}" class="me-3 w-30px" alt="" />
                                        <!--end::Icon-->
                                        <!--begin::Section-->
                                        <div class="flex-grow-1">
                                ...
                                <div class="d-flex flex-stack">
                                    ...
                                    <div class="d-flex align-items-center me-3">
                                        <!--begin::Icon-->
                                        <img src="{{ getFileVersion('/assets/admin/media/svg/brand-logos/facebook-3.svg') }}" class="me-3 w-30px" alt="" />
                                        <!--end::Icon-->
                                        <!--begin::Section-->
                                        <div class="flex-grow-1">
