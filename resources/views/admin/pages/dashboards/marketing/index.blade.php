        ...
        <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex align-items-stretch">
            ...
            <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
                ...
                <div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex flex-column justify-content-center text-gray-900 fw-bold fs-3 m-0">Marketing Dashboard</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                            ...
                            <ul class="nav nav-pills nav-pills-custom mb-3">
                                ...
                                <li class="nav-item mb-3 me-3 me-lg-6">
                                    ...
                                    <a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden active w-80px h-85px py-4" data-bs-toggle="pill" href="#kt_stats_widget_1_tab_1">
                                        <!--begin::Icon-->
                                        <div class="nav-icon">
                                            <img alt="" src="{{ getFileVersion('/assets/admin/media/svg/brand-logos/beats-electronics.svg') }}" class="" />
                                        </div>
                                        <!--end::Icon-->
                                        <!--begin::Subtitle-->
                                ...
                                <li class="nav-item mb-3 me-3 me-lg-6">
                                    ...
                                    <a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden w-80px h-85px py-4" data-bs-toggle="pill" href="#kt_stats_widget_1_tab_2">
                                        <!--begin::Icon-->
                                        <div class="nav-icon">
                                            <img alt="Logo" src="{{ getFileVersion('/assets/admin/media/svg/brand-logos/amazon.svg') }}" class="theme-light-show" />
                                            <img alt="Logo" src="{{ getFileVersion('/assets/admin/media/svg/brand-logos/amazon-dark.svg') }}" class="theme-dark-show" />
                                        </div>
                                        <!--end::Icon-->
                                        <!--begin::Subtitle-->
                                ...
                                <li class="nav-item mb-3 me-3 me-lg-6">
                                    ...
                                    <a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden w-80px h-85px py-4" data-bs-toggle="pill" href="#kt_stats_widget_1_tab_3">
                                        <!--begin::Icon-->
                                        <div class="nav-icon">
                                            <img alt="" src="{{ getFileVersion('/assets/admin/media/svg/brand-logos/bp-2.svg') }}" class="" />
                                        </div>
                                        <!--end::Icon-->
                                        <!--begin::Subtitle-->
                                ...
                                <li class="nav-item mb-3 me-3 me-lg-6">
                                    ...
                                    <a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden w-80px h-85px py-4" data-bs-toggle="pill" href="#kt_stats_widget_1_tab_4">
                                        <!--begin::Icon-->
                                        <div class="nav-icon">
                                            <img alt="" src="{{ getFileVersion('/assets/admin/media/svg/brand-logos/slack-icon.svg') }}" class="nav-icon" />
                                        </div>
                                        <!--end::Icon-->
                                        <!--begin::Subtitle-->
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex flex-stack">
                                        ...
                                        <div class="d-flex align-items-center me-3">
                                            <!--begin::Icon-->
                                            <img src="{{ getFileVersion('/assets/admin/media/svg/brand-logos/dribbble-icon-1.svg') }}" class="me-3 w-30px" alt="" />
                                            <!--end::Icon-->
                                            <!--begin::Section-->
                                    ...
                                    <div class="d-flex flex-stack">
                                        ...
                                        <div class="d-flex align-items-center me-3">
                                            <!--begin::Icon-->
                                            <img src="{{ getFileVersion('/assets/admin/media/svg/brand-logos/instagram-2-1.svg') }}" class="me-3 w-30px" alt="" />
                                            <!--end::Icon-->
                                            <!--begin::Section-->
                                            <div class="flex-grow-1">
                                    ...
                                    <div class="d-flex flex-stack">
                                        ...
                                        <div class="d-flex align-items-center me-3">
                                            <!--begin::Icon-->
                                            <img src="{{ getFileVersion('/assets/admin/media/svg/brand-logos/slack-icon.svg') }}" class="me-3 w-30px" alt="" />
                                            <!--end::Icon-->
                                            <!--begin::Section-->
                                            <div class="flex-grow-1">
                                    ...
                                    <div class="d-flex flex-stack">
                                        ...
                                        <div class="d-flex align-items-center me-3">
                                            <!--begin::Icon-->
                                            <img src="{{ getFileVersion('/assets/admin/media/svg/brand-logos/google-icon.svg') }}" class="me-3 w-30px" alt="" />
                                            <!--end::Icon-->
                                            <!--begin::Section-->
                                            <div class="flex-grow-1">
                        ...
                        <div class="card-body pt-1">
                            ...
                            <div class="d-flex flex-stack flex-wrap gap-4">
                                ...
                                <div class="d-flex align-items-center gap-4">
                                    ...
                                    <!--begin::Menu 1-->
                                    <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_65a11662a5cff">
                                        <!--begin::Header-->
                                        <div class="px-7 py-5">
                                        ...
                                        <div class="px-7 py-5">
                                            ...
                                            <div class="mb-10">
                                                ...
                                                <!--begin::Input-->
                                                <div>
                                                    <select class="form-select form-select-solid" multiple="multiple" data-kt-select2="true" data-close-on-select="false" data-placeholder="Select option" data-dropdown-parent="#kt_menu_65a11662a5cff" data-allow-clear="true">
                                                        <option></option>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="d-flex gap-2 mb-2">
                                                <a href="#">
                                                    <img src="{{ getFileVersion('/assets/admin/media/svg/brand-logos/facebook-4.svg') }}" class="w-20px" alt="" />
                                                </a>
                                                <a href="#">
                                                    <img src="{{ getFileVersion('/assets/admin/media/svg/brand-logos/twitter-2.svg') }}" class="w-20px" alt="" />
                                                </a>
                                                <a href="#">
                                                    <img src="{{ getFileVersion('/assets/admin/media/svg/brand-logos/linkedin-2.svg') }}" class="w-20px" alt="" />
                                                </a>
                                                <a href="#">
                                                    <img src="{{ getFileVersion('/assets/admin/media/svg/brand-logos/youtube-3.svg') }}" class="w-20px" alt="" />
                                                </a>
                                            </div>
                                            <!--end::Icons-->
                                        ...
                                        <td class="min-w-125px">
                                            ...
                                            <div class="symbol-group symbol-hover mb-1">
                                                ...
                                                <!--begin::Member-->
                                                <div class="symbol symbol-circle symbol-25px">
                                                    <img src="{{ getFileVersion('/assets/admin/media/avatars/300-5.jpg') }}" alt="" />
                                                </div>
                                                <!--end::Member-->
                                                <!--begin::Member-->
                                                <div class="symbol symbol-circle symbol-25px">
                                                    <img src="{{ getFileVersion('/assets/admin/media/avatars/300-25.jpg') }}" alt="" />
                                                </div>
                                                <!--end::Member-->
                                                <!--begin::Member-->
                                                <div class="symbol symbol-circle symbol-25px">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="d-flex gap-2 mb-2">
                                                ...
                                                <a href="#">
                                                    <img src="{{ getFileVersion('/assets/admin/media/svg/brand-logos/instagram-2-1.svg') }}" class="w-20px" alt="" />
                                                </a>
                                                <a href="#">
                                                    <img src="{{ getFileVersion('/assets/admin/media/svg/brand-logos/youtube-3.svg') }}" class="w-20px" alt="" />
                                                </a>
                                        ...
                                        <td class="min-w-125px">
                                            ...
                                            <div class="symbol-group symbol-hover mb-1">
                                                <!--begin::Member-->
                                                <div class="symbol symbol-circle symbol-25px">
                                                    <img src="{{ getFileVersion('/assets/admin/media/avatars/300-1.jpg') }}" alt="" />
                                                </div>
                                                <!--end::Member-->
                                                <!--begin::Member-->
                                                <div class="symbol symbol-circle symbol-25px">
                                    ...
                                    <tr>
                                        ...
                                        <td class="min-w-125px">
                                            ...
                                            <div class="symbol-group symbol-hover mb-1">
                                                ...
                                                <!--begin::Member-->
                                                <div class="symbol symbol-circle symbol-25px">
                                                    <img src="{{ getFileVersion('/assets/admin/media/avatars/300-13.jpg') }}" alt="" />
                                                </div>
                                                <!--end::Member-->
                                            </div>
                                            <!--end::Team members-->
                        ...
                        <div class="card-body d-flex flex-column flex-center">
                            ...
                            <div class="mb-2">
                                ...
                                <div class="py-10 text-center">
                                    <img src="{{ getFileVersion('/assets/admin/media/svg/illustrations/easy/1.svg') }}" class="theme-light-show w-200px" alt="" />
                                    <img src="{{ getFileVersion('/assets/admin/media/svg/illustrations/easy/1-dark.svg') }}" class="theme-dark-show w-200px" alt="" />
                                </div>
                                <!--end::Illustration-->
                            </div>
                            <!--end::Heading-->
                            ...
                            <div class="text-center mb-1">
                                ...
                                <!--end::Link-->
                                <!--begin::Link-->
                                <a class="btn btn-sm btn-light" href="{{ route('admin.pages.user-profile.followers') }}">Learn more</a>
                                <!--end::Link-->
                            </div>
                            <!--end::Links-->
                        </div>
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active" id="kt_timeline_widget_1_tab_day" role="tabpanel" aria-labelledby="day-tab" data-kt-timeline-widget-1-blockui="true">
                                    <div class="table-responsive pb-10">
                                        <!--begin::Timeline-->
                                        <div id="kt_timeline_widget_1_1" class="vis-timeline-custom h-350px min-w-700px" data-kt-timeline-widget-1-image-root="{{ public_path('assets/admin/media/') }}"></div>
                                        <!--end::Timeline-->
                                    </div>
                                </div>
                                <!--end::Tab pane-->
                                ...
                                <div class="tab-pane" id="kt_timeline_widget_1_tab_week" role="tabpanel" aria-labelledby="week-tab" data-kt-timeline-widget-1-blockui="true">
                                    <div class="table-responsive pb-10">
                                        <!--begin::Timeline-->
                                        <div id="kt_timeline_widget_1_2" class="vis-timeline-custom h-350px min-w-700px" data-kt-timeline-widget-1-image-root="{{ public_path('assets/admin/media/') }}"></div>
                                        <!--end::Timeline-->
                                    </div>
                                </div>
                                <!--end::Tab pane-->
                                ...
                                <div class="tab-pane" id="kt_timeline_widget_1_tab_month" role="tabpanel" aria-labelledby="month-tab" data-kt-timeline-widget-1-blockui="true">
                                    <div class="table-responsive pb-10">
                                        <!--begin::Timeline-->
                                        <div id="kt_timeline_widget_1_3" class="vis-timeline-custom h-350px min-w-700px" data-kt-timeline-widget-1-image-root="{{ public_path('assets/admin/media/') }}"></div>
                                        <!--end::Timeline-->
                                    </div>
                                </div>
                                <!--end::Tab pane-->
