        ...
        <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex align-items-stretch">
            ...
            <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
                ...
                <div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex flex-column justify-content-center text-gray-900 fw-bold fs-3 m-0">My Balance: 37,045$</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                    ...
                    <div class="row g-5 g-xl-10">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="card card-flush h-xl-100" style="background-color: #F6E5CA">
                                ...
                                <div class="card-body text-center pt-5">
                                    <!--begin::Image-->
                                    <img src="{{ getFileVersion('/assets/admin/media/svg/shapes/bitcoin.svg') }}" class="h-125px mb-5" alt="" />
                                    <!--end::Image-->
                                    <!--begin::Section-->
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="card card-flush h-xl-100" style="background-color: #F3D6EF">
                                ...
                                <div class="card-body text-center pt-5">
                                    <!--begin::Image-->
                                    <img src="{{ getFileVersion('/assets/admin/media/svg/shapes/ethereum.svg') }}" class="h-125px mb-5" alt="" />
                                    <!--end::Image-->
                                    <!--begin::Section-->
                                    <div class="text-start">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="card card-flush h-xl-100" style="background-color: #BFDDE3">
                                ...
                                <div class="card-body text-center pt-5">
                                    <!--begin::Image-->
                                    <img src="{{ getFileVersion('/assets/admin/media/svg/shapes/dogecoin.svg') }}" class="h-125px mb-5" alt="" />
                                    <!--end::Image-->
                                    <!--begin::Section-->
                                    <div class="text-start">
                                ...
                                <div class="tab-pane fade active show" id="kt_forms_widget_1_tab_content_1">
                                    ...
                                    <div class="form-floating border border-gray-300 rounded mb-7">
                                        <select class="form-select form-select-transparent" id="kt_forms_widget_1_select_1">
                                            <option></option>
                                            <option value="0" data-kt-select2-icon="{{ getFileVersion('/assets/admin/media/svg/coins/bitcoin.svg') }}" selected="selected">Bitcoin/BTC</option>
                                            <option value="1" data-kt-select2-icon="{{ getFileVersion('/assets/admin/media/svg/coins/ethereum.svg') }}">Ethereum/ETH</option>
                                            <option value="2" data-kt-select2-icon="{{ getFileVersion('/assets/admin/media/svg/coins/filecoin.svg') }}">Filecoin/FLE</option>
                                            <option value="3" data-kt-select2-icon="{{ getFileVersion('/assets/admin/media/svg/coins/chainlink.svg') }}">Chainlink/CIN</option>
                                            <option value="4" data-kt-select2-icon="{{ getFileVersion('/assets/admin/media/svg/coins/binance.svg') }}">Binance/BCN</option>
                                        </select>
