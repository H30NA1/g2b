        ...
        <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex align-items-stretch">
            ...
            <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
                ...
                <div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex flex-column justify-content-center text-gray-900 fw-bold fs-3 m-0">Store Analytics</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <img src="{{ getFileVersion('/assets/admin/media/stock/ecommerce/210.png') }}" class="w-50px" alt="" />
                                            </td>
                                            <td class="ps-0">
                                        ...
                                        <tr>
                                            <td>
                                                <img src="{{ getFileVersion('/assets/admin/media/stock/ecommerce/215.png') }}" class="w-50px" alt="" />
                                            </td>
                                            <td class="ps-0">
                                        ...
                                        <tr>
                                            <td>
                                                <img src="{{ getFileVersion('/assets/admin/media/stock/ecommerce/209.png') }}" class="w-50px" alt="" />
                                            </td>
                                            <td class="ps-0">
                                        ...
                                        <tr>
                                            <td>
                                                <img src="{{ getFileVersion('/assets/admin/media/stock/ecommerce/214.png') }}" class="w-50px" alt="" />
                                            </td>
                                            <td class="ps-0">
                    ...
                    <div class="card card-flush h-xl-100">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="m-0">
                                ...
                                <div class="d-flex flex-stack">
                                    <!--begin::Flag-->
                                    <img src="{{ getFileVersion('/assets/admin/media/flags/united-states.svg') }}" class="me-4 w-25px" style="border-radius: 4px" alt="" />
                                    <!--end::Flag-->
                                    <!--begin::Section-->
                                ...
                                <div class="d-flex flex-stack">
                                    <!--begin::Flag-->
                                    <img src="{{ getFileVersion('/assets/admin/media/flags/brazil.svg') }}" class="me-4 w-25px" style="border-radius: 4px" alt="" />
                                    <!--end::Flag-->
                                    <!--begin::Section-->
                                    <div class="d-flex flex-stack flex-row-fluid d-grid gap-2">
                                        <!--begin::Content-->
                                ...
                                <div class="d-flex flex-stack">
                                    <!--begin::Flag-->
                                    <img src="{{ getFileVersion('/assets/admin/media/flags/turkey.svg') }}" class="me-4 w-25px" style="border-radius: 4px" alt="" />
                                    <!--end::Flag-->
                                    <!--begin::Section-->
                                    <div class="d-flex flex-stack flex-row-fluid d-grid gap-2">
                                        <!--begin::Content-->
                                ...
                                <div class="d-flex flex-stack">
                                    <!--begin::Flag-->
                                    <img src="{{ getFileVersion('/assets/admin/media/flags/france.svg') }}" class="me-4 w-25px" style="border-radius: 4px" alt="" />
                                    <!--end::Flag-->
                                    <!--begin::Section-->
                                    <div class="d-flex flex-stack flex-row-fluid d-grid gap-2">
                                        <!--begin::Content-->
                                ...
                                <div class="d-flex flex-stack">
                                    <!--begin::Flag-->
                                    <img src="{{ getFileVersion('/assets/admin/media/flags/india.svg') }}" class="me-4 w-25px" style="border-radius: 4px" alt="" />
                                    <!--end::Flag-->
                                    <!--begin::Section-->
                                    <div class="d-flex flex-stack flex-row-fluid d-grid gap-2">
                                        <!--begin::Content-->
                                ...
                                <div class="d-flex flex-stack">
                                    <!--begin::Flag-->
                                    <img src="{{ getFileVersion('/assets/admin/media/flags/sweden.svg') }}" class="me-4 w-25px" style="border-radius: 4px" alt="" />
                                    <!--end::Flag-->
                                    <!--begin::Section-->
                                    <div class="d-flex flex-stack flex-row-fluid d-grid gap-2">
                                        <!--begin::Content-->
                ...
                <div class="col-xl-4 mb-xl-10">
                    ...
                    <div class="card card-flush h-xl-100">
                        ...
                        <div class="card-body card-body d-flex justify-content-between flex-column pt-3">
                            ...
                            <div class="d-flex flex-stack">
                                <!--begin::Flag-->
                                <img src="{{ getFileVersion('/assets/admin/media/svg/brand-logos/dribbble-icon-1.svg') }}" class="me-4 w-30px" style="border-radius: 4px" alt="" />
                                <!--end::Flag-->
                                <!--begin::Section-->
                            ...
                            <div class="d-flex flex-stack">
                                <!--begin::Flag-->
                                <img src="{{ getFileVersion('/assets/admin/media/svg/brand-logos/linkedin-1.svg') }}" class="me-4 w-30px" style="border-radius: 4px" alt="" />
                                <!--end::Flag-->
                                <!--begin::Section-->
                                <div class="d-flex align-items-center flex-stack flex-wrap flex-row-fluid d-grid gap-2">
                                    <!--begin::Content-->
                            ...
                            <div class="d-flex flex-stack">
                                <!--begin::Flag-->
                                <img src="{{ getFileVersion('/assets/admin/media/svg/brand-logos/slack-icon.svg') }}" class="me-4 w-30px" style="border-radius: 4px" alt="" />
                                <!--end::Flag-->
                                <!--begin::Section-->
                                <div class="d-flex align-items-center flex-stack flex-wrap flex-row-fluid d-grid gap-2">
                                    <!--begin::Content-->
                            ...
                            <div class="d-flex flex-stack">
                                <!--begin::Flag-->
                                <img src="{{ getFileVersion('/assets/admin/media/svg/brand-logos/youtube-3.svg') }}" class="me-4 w-30px" style="border-radius: 4px" alt="" />
                                <!--end::Flag-->
                                <!--begin::Section-->
                                <div class="d-flex align-items-center flex-stack flex-wrap flex-row-fluid d-grid gap-2">
                                    <!--begin::Content-->
                            ...
                            <div class="d-flex flex-stack">
                                <!--begin::Flag-->
                                <img src="{{ getFileVersion('/assets/admin/media/svg/brand-logos/instagram-2-1.svg') }}" class="me-4 w-30px" style="border-radius: 4px" alt="" />
                                <!--end::Flag-->
                                <!--begin::Section-->
                                <div class="d-flex align-items-center flex-stack flex-wrap flex-row-fluid d-grid gap-2">
                                    <!--begin::Content-->
                            ...
                            <div class="d-flex flex-stack">
                                <!--begin::Flag-->
                                <img src="{{ getFileVersion('/assets/admin/media/svg/brand-logos/facebook-3.svg') }}" class="me-4 w-30px" style="border-radius: 4px" alt="" />
                                <!--end::Flag-->
                                <!--begin::Section-->
                                <div class="d-flex align-items-center flex-stack flex-wrap flex-row-fluid d-grid gap-2">
                                    <!--begin::Content-->
