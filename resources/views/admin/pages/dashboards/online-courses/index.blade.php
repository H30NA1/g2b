        ...
        <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex align-items-stretch">
            ...
            <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
                ...
                <div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex flex-column justify-content-center text-gray-900 fw-bold fs-3 m-0">Online Courses</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
            ...
            <div class="row g-5 g-xl-10">
                ...
                <div class="col-xl-4 mb-xl-10">
                    ...
                    <div class="card card-flush h-xl-100">
                        <!--begin::Heading-->
                        <div class="card-header rounded bgi-no-repeat bgi-size-cover bgi-position-y-top bgi-position-x-center align-items-start h-250px" style="background-image:url('{{ getFileVersion('/assets/admin/media/svg/shapes/top-green.png') }}')" data-bs-theme="light">
                            <!--begin::Title-->
                ...
                <div class="col-xl-8 mb-5 mb-xl-10">
                    ...
                    <div class="card border-transparent" data-bs-theme="light" style="background-color: #1C325E;">
                        ...
                        <div class="card-body d-flex ps-xl-15">
                            ...
                            <!--begin::Wrapper-->
                            <!--begin::Illustration-->
                            <img src="{{ getFileVersion('/assets/admin/media/illustrations/sigma-1/17-dark.png') }}" class="position-absolute me-3 bottom-0 end-0 h-200px" alt="" />
                            <!--end::Illustration-->
                        </div>
                        <!--end::Body-->
                    </div>
                        ...
                        <div class="card-body pt-5">
                            ...
                            <div class="d-flex flex-stack">
                                ...
                                <div class="d-flex align-items-center me-3">
                                    <!--begin::Logo-->
                                    <img src="{{ getFileVersion('/assets/admin/media/svg/brand-logos/laravel-2.svg') }}" class="me-4 w-30px" alt="" />
                                    <!--end::Logo-->
                                    <!--begin::Section-->
                            ...
                            <div class="d-flex flex-stack">
                                ...
                                <div class="d-flex align-items-center me-3">
                                    <!--begin::Logo-->
                                    <img src="{{ getFileVersion('/assets/admin/media/svg/brand-logos/vue-9.svg') }}" class="me-4 w-30px" alt="" />
                                    <!--end::Logo-->
                                    <!--begin::Section-->
                                    <div class="flex-grow-1">
                                        <!--begin::Text-->
                            ...
                            <div class="d-flex flex-stack">
                                ...
                                <div class="d-flex align-items-center me-3">
                                    <!--begin::Logo-->
                                    <img src="{{ getFileVersion('/assets/admin/media/svg/brand-logos/bootstrap5.svg') }}" class="me-4 w-30px" alt="" />
                                    <!--end::Logo-->
                                    <!--begin::Section-->
                                    <div class="flex-grow-1">
                                        <!--begin::Text-->
                            ...
                            <div class="d-flex flex-stack">
                                ...
                                <div class="d-flex align-items-center me-3">
                                    <!--begin::Logo-->
                                    <img src="{{ getFileVersion('/assets/admin/media/svg/brand-logos/angular-icon.svg') }}" class="me-4 w-30px" alt="" />
                                    <!--end::Logo-->
                                    <!--begin::Section-->
                                    <div class="flex-grow-1">
                                        <!--begin::Text-->
                            ...
                            <div class="d-flex flex-stack">
                                ...
                                <div class="d-flex align-items-center me-3">
                                    <!--begin::Logo-->
                                    <img src="{{ getFileVersion('/assets/admin/media/svg/brand-logos/spring-3.svg') }}" class="me-4 w-30px" alt="" />
                                    <!--end::Logo-->
                                    <!--begin::Section-->
                                    <div class="flex-grow-1">
                                        <!--begin::Text-->
                            ...
                            <div class="d-flex flex-stack">
                                ...
                                <div class="d-flex align-items-center me-3">
                                    <!--begin::Logo-->
                                    <img src="{{ getFileVersion('/assets/admin/media/svg/brand-logos/typescript-1.svg') }}" class="me-4 w-30px" alt="" />
                                    <!--end::Logo-->
                                    <!--begin::Section-->
                                    <div class="flex-grow-1">
                                        <!--begin::Text-->
