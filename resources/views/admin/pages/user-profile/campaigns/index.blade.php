        ...
        <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex align-items-stretch">
            ...
            <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
                ...
                <div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex flex-column justify-content-center text-gray-900 fw-bold fs-3 m-0">Campaigns</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                        ...
                        <div class="card-header flex-nowrap border-0 pt-9">
                            ...
                            <div class="card-title m-0">
                                ...
                                <div class="symbol symbol-45px w-45px bg-light me-5">
                                    <img src="{{ getFileVersion('/assets/admin/media/svg/brand-logos/twitch.svg') }}" alt="image" class="p-3" />
                                </div>
                                <!--end::Icon-->
                                <!--begin::Title-->
                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-header flex-nowrap border-0 pt-9">
                            ...
                            <div class="card-title m-0">
                                <!--begin::Icon-->
                                <div class="symbol symbol-45px w-45px bg-light me-5">
                                    <img src="{{ getFileVersion('/assets/admin/media/svg/brand-logos/twitter.svg') }}" alt="image" class="p-3" />
                                </div>
                                <!--end::Icon-->
                                <!--begin::Title-->
                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-header flex-nowrap border-0 pt-9">
                            ...
                            <div class="card-title m-0">
                                <!--begin::Icon-->
                                <div class="symbol symbol-45px w-45px bg-light me-5">
                                    <img src="{{ getFileVersion('/assets/admin/media/svg/brand-logos/spotify.svg') }}" alt="image" class="p-3" />
                                </div>
                                <!--end::Icon-->
                                <!--begin::Title-->
                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-header flex-nowrap border-0 pt-9">
                            ...
                            <div class="card-title m-0">
                                <!--begin::Icon-->
                                <div class="symbol symbol-45px w-45px bg-light me-5">
                                    <img src="{{ getFileVersion('/assets/admin/media/svg/brand-logos/pinterest-p.svg') }}" alt="image" class="p-3" />
                                </div>
                                <!--end::Icon-->
                                <!--begin::Title-->
                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-header flex-nowrap border-0 pt-9">
                            ...
                            <div class="card-title m-0">
                                <!--begin::Icon-->
                                <div class="symbol symbol-45px w-45px bg-light me-5">
                                    <img src="{{ getFileVersion('/assets/admin/media/svg/brand-logos/github.svg') }}" alt="image" class="p-3" />
                                </div>
                                <!--end::Icon-->
                                <!--begin::Title-->
                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-header flex-nowrap border-0 pt-9">
                            ...
                            <div class="card-title m-0">
                                <!--begin::Icon-->
                                <div class="symbol symbol-45px w-45px bg-light me-5">
                                    <img src="{{ getFileVersion('/assets/admin/media/svg/brand-logos/youtube-play.svg') }}" alt="image" class="p-3" />
                                </div>
                                <!--end::Icon-->
                                <!--begin::Title-->
                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-header flex-nowrap border-0 pt-9">
                            ...
                            <div class="card-title m-0">
                                <!--begin::Icon-->
                                <div class="symbol symbol-45px w-45px bg-light me-5">
                                    <img src="{{ getFileVersion('/assets/admin/media/svg/brand-logos/telegram.svg') }}" alt="image" class="p-3" />
                                </div>
                                <!--end::Icon-->
                                <!--begin::Title-->
                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-header flex-nowrap border-0 pt-9">
                            ...
                            <div class="card-title m-0">
                                <!--begin::Icon-->
                                <div class="symbol symbol-45px w-45px bg-light me-5">
                                    <img src="{{ getFileVersion('/assets/admin/media/svg/brand-logos/reddit.svg') }}" alt="image" class="p-3" />
                                </div>
                                <!--end::Icon-->
                                <!--begin::Title-->
