											...
											<ul class="dropdown-menu dropdown-menu-end">
												<li class="dropdown-item">
                                                    <a href="{{ route('web.profile.edit') }}">
                                                        <i class="fa fa-user-circle text-primary me-2"></i> Edit
                                                    </a>
                                                </li>
											</ul>
										</div>
									...
									<div class="card-body">
										<div class="profile-statistics">
											<div class="text-center">
												<div class="row">
													<div class="col">
														<h3 class="m-b-0">{{ isset($user->projects) ? $user->projects->count() : 0 }}</h3><span>Projects</span>
													</div>
													<div class="col">
														<h3 class="m-b-0">{{ isset($user->tasks) ? $user->tasks->count() : 0 }}</h3><span>Tasks</span>
													</div>
													<div class="col">
								...
								<div class="card">
									<div class="card-body">
										<div class="profile-blog">
											...
											<img src="{{ getFileVersion('/assets/images/profile/1.jpg') }}" alt="" class="img-fluid mt-4 mb-4 w-100 rounded">
									...
									<div class="card-body">
										<div class="profile-interest">
											...
											<div class="row mt-3 sp4" id="lightgallery">
												<a href="{{ getFileVersion('/assets/images/profile/2.jpg') }}" data-exthumbimage="{{ getFileVersion('/assets/images/profile/2.jpg') }}" data-src="{{ getFileVersion('/assets/images/profile/2.jpg') }}" class="mb-1 col-lg-4 col-xl-4 col-sm-4 col-6">
													<img src="{{ getFileVersion('/assets/images/profile/2.jpg') }}" alt="" class="px-1 py-1 img-fluid rounded">
												</a>
												<a href="{{ getFileVersion('/assets/images/profile/3.jpg') }}" data-exthumbimage="{{ getFileVersion('/assets/images/profile/3.jpg') }}" data-src="{{ getFileVersion('/assets/images/profile/3.jpg') }}" class="mb-1 col-lg-4 col-xl-4 col-sm-4 col-6">
													<img src="{{ getFileVersion('/assets/images/profile/3.jpg') }}" alt="" class="px-1 py-1 img-fluid rounded">
												</a>
												<a href="{{ getFileVersion('/assets/images/profile/4.jpg') }}" data-exthumbimage="{{ getFileVersion('/assets/images/profile/4.jpg') }}" data-src="{{ getFileVersion('/assets/images/profile/4.jpg') }}" class="mb-1 col-lg-4 col-xl-4 col-sm-4 col-6">
													<img src="{{ getFileVersion('/assets/images/profile/4.jpg') }}" alt="" class="px-1 py-1 img-fluid rounded">
												</a>
												<a href="{{ getFileVersion('/assets/images/profile/3.jpg') }}" data-exthumbimage="{{ getFileVersion('/assets/images/profile/3.jpg') }}" data-src="{{ getFileVersion('/assets/images/profile/3.jpg') }}" class="mb-1 col-lg-4 col-xl-4 col-sm-4 col-6">
													<img src="{{ getFileVersion('/assets/images/profile/3.jpg') }}" alt="" class="px-1 py-1 img-fluid rounded">
												</a>
									...
									<div class="card-body">
										<div class="profile-news">
											...
											<div class="media pt-3 pb-3">
												<img src="{{ getFileVersion('/assets/images/profile/5.jpg') }}" alt="image" class="me-3 rounded" width="75">
												<div class="media-body">
													<h5 class="m-b-5"><a href="post-details.html" class="text-black">Compete this projects Monday</a></h5>
													<p class="mb-0">I shared this on my fb wall a few months back, and I thought.</p>
												</div>
											</div>
											<div class="media pt-3 pb-3">
												<img src="{{ getFileVersion('/assets/images/profile/6.jpg') }}" alt="image" class="me-3 rounded" width="75">
												<div class="media-body">
													<h5 class="m-b-5"><a href="post-details.html" class="text-black">Development planning</a></h5>
													<p class="mb-0">I shared this on my fb wall a few months back, and I thought.</p>
												</div>
											</div>
											<div class="media pt-3 pb-0">
												<img src="{{ getFileVersion('/assets/images/profile/7.jpg') }}" alt="image" class="me-3 rounded" width="75">
												<div class="media-body">
													<h5 class="m-b-5"><a href="post-details.html" class="text-black">Software planning</a></h5>
													<p class="mb-0">I shared this on my fb wall a few months back, and I thought.</p>
												</div>
											</div>
										</div>
                                            ...
                                            <div id="my-posts" class="tab-pane fade active show">
                                                <div class="my-post-content pt-3">
                                                    ...
                                                    <div class="profile-uoloaded-post border-bottom-1 pb-5">
                                                        <img src="{{ getFileVersion('/assets/images/profile/8.jpg') }}" alt="" class="img-fluid w-100 rounded">
                                                    ...
                                                    <div class="profile-uoloaded-post border-bottom-1 pb-5">
                                                        <img src="{{ getFileVersion('/assets/images/profile/9.jpg') }}" alt="" class="img-fluid w-100 rounded">
														<a class="post-title" href="post-details.html"><h3 class="text-black">Collection of textile samples lay spread</h3></a>
                                                        <p>A wonderful serenity has take possession of my entire soul like these sweet morning of spare which enjoy whole heart.A wonderful serenity has take possession of my entire soul like these sweet morning
                                                            of spare which enjoy whole heart.</p>
                                                        <button class="btn btn-primary me-2"><span class="me-2"><i
