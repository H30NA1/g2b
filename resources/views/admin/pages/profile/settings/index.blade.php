...
<div class="d-flex flex-column flex-column-fluid">
    ...
    <div id="kt_app_content" class="app-content flex-column-fluid">
        ...
        <div id="kt_app_content_container" class="app-container container-fluid">
            ...
            <!--end::Navbar-->
            <!--begin::Basic info-->
            <div class="card mb-5 mb-xl-10" id="profile-settings">
                <!--begin::Card header-->
                    ...
                    <form id="kt_account_profile_details_form" class="form">
                        ...
                        <div class="card-body border-top p-9">
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8">
                                    <!--begin::Image input-->
                                    <div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url('{{ getFileVersion('/assets/admin/media/svg/avatars/blank.svg') }}')">
                                        <!--begin::Preview existing avatar-->
                                        <div class="image-input-wrapper w-125px h-125px" style="background-image: url({{ getFileVersion('/assets/admin/media/avatars/300-1.jpg') }})"></div>
                    ...
                    <div class="card-body border-top p-9">
                        ...
                        <div class="py-2">
                            ...
                            <div class="d-flex flex-stack">
                                <div class="d-flex">
                                    <img src="{{ getFileVersion('/assets/admin/media/svg/brand-logos/google-icon.svg') }}" class="w-30px me-6" alt="" />
                                    <div class="d-flex flex-column">
                            ...
                            <div class="d-flex flex-stack">
                                <div class="d-flex">
                                    <img src="{{ getFileVersion('/assets/admin/media/svg/brand-logos/github.svg') }}" class="w-30px me-6" alt="" />
                                    <div class="d-flex flex-column">
                            ...
                            <div class="d-flex flex-stack">
                                <div class="d-flex">
                                    <img src="{{ getFileVersion('/assets/admin/media/svg/brand-logos/slack-icon.svg') }}" class="w-30px me-6" alt="" />
                                    <div class="d-flex flex-column">
