...
<!-- clockpicker -->
<script src="{{ getFileVersion('/assets/admin/vendor/clockpicker/js/bootstrap-clockpicker.min.js') }}"></script>
<!-- Clockpicker init -->
<script src="{{ getFileVersion('/assets/admin/js/plugins-init/clock-picker-init.js') }}"></script>
<script src="{{ getFileVersion('/assets/admin/js/dashboard/core-hr.js') }}"></script>
<script src="{{ getFileVersion('/assets/admin/vendor/dropzone/dist/dropzone.js') }}"></script>
