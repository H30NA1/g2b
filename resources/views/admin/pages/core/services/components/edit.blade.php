<form action="{{ route('web.services.update', ['id' => $service->id]) }}" method="POST" enctype="multipart/form-data">
    @csrf
    <!-- row -->
    <div class="row">
                    ...
                    <div class="card-body p-0">
                        <div id="DZ_W_Todo4" class="widget-media dz-scroll height370 my-4 px-4">
                            <ul class="nav nav-tabs" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                    <a href="#servers" data-bs-toggle="tab" class="nav-link" aria-selected="false" role="tab" tabindex="-1">Servers</a>
                                </li>
                                <li class="nav-item" role="presentation">
                            ...
                            <div class="tab-content mt30">
                                @include('pages.core.services.components.info')
                                @include('pages.core.services.components.servers')
                                @include('pages.core.services.components.projects')
                            </div>
                        </div>
                    </div>
                </div>
