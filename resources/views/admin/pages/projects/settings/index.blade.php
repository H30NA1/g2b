                    ...
                    <div class="row mb-5">
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url('{{ getFileVersion('/assets/admin/media/svg/avatars/blank.svg') }}')">
                                ...
                                <div class="image-input-wrapper w-125px h-125px bgi-position-center" style="background-size: 75%; background-image: url('{{ getFileVersion('/assets/admin/media/svg/brand-logos/volicity-9.svg') }}')"></div>
