    ...
    <div id="kt_app_content_container" class="app-container container-fluid">
        ...
        <div class="d-flex flex-wrap flex-stack my-5">
            ...
            <div class="d-flex my-2">
                ...
                <!--end::Search-->
                <a href="{{ route('admin.pages.file-manager.index') }}" class='btn btn-primary btn-sm fw-bolder'>File Manager</a>
            </div>
            <!--end::Controls-->
        </div>
        <!--end::Toolbar-->
        ...
        <div class="row g-6 g-xl-9 mb-6 mb-xl-9">
            ...
            <div class="col-md-6 col-lg-4 col-xl-3">
                ...
                <div class="card h-100 flex-center bg-light-primary border-primary border border-dashed p-8">
                    <!--begin::Image-->
                    <img src="{{ getFileVersion('/assets/admin/media/svg/files/upload.svg') }}" class="mb-5" alt="" />
                    <!--end::Image-->
                    <!--begin::Link-->
