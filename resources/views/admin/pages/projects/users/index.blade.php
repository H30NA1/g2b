                        ...
                        <div class="card">
                            ...
                            <div class="card-body d-flex flex-center flex-column pt-12 p-9">
                                ...
                                <div class="symbol symbol-65px symbol-circle mb-5">
                                    <img src="{{ getFileVersion('/assets/admin/media/avatars/300-2.jpg') }}" alt="image" />
                            ...
                            <div class="py-5">
                                ...
                                <div data-kt-search-element="empty" class="text-center d-none">
                                    ...
                                    <div class="text-center px-5">
                                        <img src="{{ getFileVersion('/assets/admin/media/illustrations/sketchy-1/1.png') }}" alt="" class="w-100 h-200px h-sm-325px" />
                                    </div>
                                    <!--end::Illustration-->
                                </div>
                                <!--end::Empty-->
