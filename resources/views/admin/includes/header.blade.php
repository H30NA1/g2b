                                            ...
                                            <div class="tab-content py-4 py-lg-8 px-lg-7">
                                                ...
                                                <div class="tab-pane w-lg-1000px" id="kt_app_header_menu_pages_utilities">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-5 pe-lg-5">
                                                            <img src="{{ getFileVersion('/assets/admin/media/stock/600x600/img-84.jpg') }}" class="rounded mw-100" alt="" />
                                                        </div>
                                                        <!--end:Col-->
                                                    </div>
                                                    <!--end:Row-->
                                                ...
                                                <div class="tab-pane w-lg-500px" id="kt_app_header_menu_pages_widgets">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <!--begin:Col-->
                                                        <div class="col-lg-8">
                                                            <img src="{{ getFileVersion('/assets/admin/media/stock/900x600/44.jpg') }}" class="rounded mw-100" alt="" />
                                                        </div>
                                                        <!--end:Col-->
                                                    </div>
                                                    <!--end:Row-->
                                        ...
                                        <div class="row g-2">
                                            ...
                                            <div class="col-4">
                                                <a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                                    <img src="{{ getFileVersion('/assets/admin/media/svg/brand-logos/amazon.svg') }}" class="w-25px h-25px mb-2" alt="" />
                                            ...
                                            <div class="col-4">
                                                <a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                                    <img src="{{ getFileVersion('/assets/admin/media/svg/brand-logos/angular-icon-1.svg') }}" class="w-25px h-25px mb-2" alt="" />
                                            ...
                                            <div class="col-4">
                                                <a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                                    <img src="{{ getFileVersion('/assets/admin/media/svg/brand-logos/atica.svg') }}" class="w-25px h-25px mb-2" alt="" />
                                            ...
                                            <div class="col-4">
                                                <a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                                    <img src="{{ getFileVersion('/assets/admin/media/svg/brand-logos/beats-electronics.svg') }}" class="w-25px h-25px mb-2" alt="" />
                                            ...
                                            <div class="col-4">
                                                <a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                                    <img src="{{ getFileVersion('/assets/admin/media/svg/brand-logos/codeigniter.svg') }}" class="w-25px h-25px mb-2" alt="" />
                                            ...
                                            <div class="col-4">
                                                <a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                                    <img src="{{ getFileVersion('/assets/admin/media/svg/brand-logos/bootstrap-4.svg') }}" class="w-25px h-25px mb-2" alt="" />
                                            ...
                                            <div class="col-4">
                                                <a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                                    <img src="{{ getFileVersion('/assets/admin/media/svg/brand-logos/google-tag-manager.svg') }}" class="w-25px h-25px mb-2" alt="" />
                                            ...
                                            <div class="col-4">
                                                <a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                                    <img src="{{ getFileVersion('/assets/admin/media/svg/brand-logos/disqus.svg') }}" class="w-25px h-25px mb-2" alt="" />
                                            ...
                                            <div class="col-4">
                                                <a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                                    <img src="{{ getFileVersion('/assets/admin/media/svg/brand-logos/dribbble-icon-1.svg') }}" class="w-25px h-25px mb-2" alt="" />
                                            ...
                                            <div class="col-4">
                                                <a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                                    <img src="{{ getFileVersion('/assets/admin/media/svg/brand-logos/google-play-store.svg') }}" class="w-25px h-25px mb-2" alt="" />
                                            ...
                                            <div class="col-4">
                                                <a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                                    <img src="{{ getFileVersion('/assets/admin/media/svg/brand-logos/google-podcasts.svg') }}" class="w-25px h-25px mb-2" alt="" />
                                            ...
                                            <div class="col-4">
                                                <a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                                    <img src="{{ getFileVersion('/assets/admin/media/svg/brand-logos/figma-1.svg') }}" class="w-25px h-25px mb-2" alt="" />
                                            ...
                                            <div class="col-4">
                                                <a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                                    <img src="{{ getFileVersion('/assets/admin/media/svg/brand-logos/github.svg') }}" class="w-25px h-25px mb-2" alt="" />
                                            ...
                                            <div class="col-4">
                                                <a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                                    <img src="{{ getFileVersion('/assets/admin/media/svg/brand-logos/gitlab.svg') }}" class="w-25px h-25px mb-2" alt="" />
                                            ...
                                            <div class="col-4">
                                                <a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                                    <img src="{{ getFileVersion('/assets/admin/media/svg/brand-logos/instagram-2-1.svg') }}" class="w-25px h-25px mb-2" alt="" />
                                            ...
                                            <div class="col-4">
                                                <a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                                    <img src="{{ getFileVersion('/assets/admin/media/svg/brand-logos/pinterest-p.svg') }}" class="w-25px h-25px mb-2" alt="" />
                                ...
                                <a href="#" class="menu-link px-5">
                                    <span class="menu-title position-relative">Language
                                        <span class="fs-8 rounded bg-light px-3 py-2 position-absolute translate-middle-y top-50 end-0">English
                                            <img class="w-15px h-15px rounded-1 ms-2" src="{{ getFileVersion('/assets/admin/media/flags/united-states.svg') }}" alt="" /></span></span>
                                </a>
                                <!--begin::Menu sub-->
                                <div class="menu-sub menu-sub-dropdown w-175px py-4">
                                    <!--begin::Menu item-->
                                ...
                                <div data-kt-search-element="results" class="d-none">
                                    ...
                                    <div class="scroll-y mh-200px mh-lg-350px">
                                        ...
                                        <a href="#" class="d-flex text-gray-900 text-hover-primary align-items-center mb-5">
                                            <!--begin::Symbol-->
                                            <div class="symbol symbol-40px me-4">
                                                <img src="{{ getFileVersion('/assets/admin/media/avatars/300-2.jpg') }}" alt="" />
                                            </div>
                                            <!--end::Symbol-->
                                            <!--begin::Title-->
                                            <div class="d-flex flex-column justify-content-start fw-semibold">
                                        ...
                                        <a href="#" class="d-flex text-gray-900 text-hover-primary align-items-center mb-5">
                                            <!--begin::Symbol-->
                                            <div class="symbol symbol-40px me-4">
                                                <img src="{{ getFileVersion('/assets/admin/media/avatars/300-11.jpg') }}" alt="" />
                                            </div>
                                            <!--end::Symbol-->
                                            <!--begin::Title-->
                                            <div class="d-flex flex-column justify-content-start fw-semibold">
                                        ...
                                        <a href="#" class="d-flex text-gray-900 text-hover-primary align-items-center mb-5">
                                            ...
                                            <div class="symbol symbol-40px me-4">
                                                <span class="symbol-label bg-light">
                                                    <img class="w-20px h-20px" src="{{ getFileVersion('/assets/admin/media/svg/brand-logos/volicity-9.svg') }}" alt="" />
                                                </span>
                                            </div>
                                            <!--end::Symbol-->
                                            <!--begin::Title-->
                                        ...
                                        <a href="#" class="d-flex text-gray-900 text-hover-primary align-items-center mb-5">
                                            ...
                                            <div class="symbol symbol-40px me-4">
                                                <span class="symbol-label bg-light">
                                                    <img class="w-20px h-20px" src="{{ getFileVersion('/assets/admin/media/svg/brand-logos/tvit.svg') }}" alt="" />
                                                </span>
                                            </div>
                                            <!--end::Symbol-->
                                            <!--begin::Title-->
                                        ...
                                        <a href="#" class="d-flex text-gray-900 text-hover-primary align-items-center mb-5">
                                            ...
                                            <div class="symbol symbol-40px me-4">
                                                <span class="symbol-label bg-light">
                                                    <img class="w-20px h-20px" src="{{ getFileVersion('/assets/admin/media/svg/misc/infography.svg') }}" alt="" />
                                                </span>
                                            </div>
                                            <!--end::Symbol-->
                                            <!--begin::Title-->
                                        ...
                                        <a href="#" class="d-flex text-gray-900 text-hover-primary align-items-center mb-5">
                                            ...
                                            <div class="symbol symbol-40px me-4">
                                                <span class="symbol-label bg-light">
                                                    <img class="w-20px h-20px" src="{{ getFileVersion('/assets/admin/media/svg/brand-logos/leaf.svg') }}" alt="" />
                                                </span>
                                            </div>
                                            <!--end::Symbol-->
                                            <!--begin::Title-->
                                        ...
                                        <a href="#" class="d-flex text-gray-900 text-hover-primary align-items-center mb-5">
                                            ...
                                            <div class="symbol symbol-40px me-4">
                                                <span class="symbol-label bg-light">
                                                    <img class="w-20px h-20px" src="{{ getFileVersion('/assets/admin/media/svg/brand-logos/tower.svg') }}" alt="" />
                                                </span>
                                            </div>
                                            <!--end::Symbol-->
                                            <!--begin::Title-->
