                        ...
                        <div class="col-xl-4 active-country dz-scroll">
                            <div class="">
                                <div class="country-list">
                                    <img src="{{ getFileVersion('/assets/images/country/india.png') }}" alt="">
                                    <div class="progress-box mt-0">
                                        <div class="d-flex justify-content-between">
                                ...
                                <div class="country-list">
                                    <img src="{{ getFileVersion('/assets/images/country/canada.png') }}" alt="">
                                    <div class="progress-box mt-0">
                                        <div class="d-flex justify-content-between">
                                ...
                                <div class="country-list">
                                    <img src="{{ getFileVersion('/assets/images/country/russia.png') }}" alt="">
                                    <div class="progress-box mt-0">
                                        <div class="d-flex justify-content-between">
                                ...
                                <div class="country-list">
                                    <img src="{{ getFileVersion('/assets/images/country/uk.png') }}" alt="">
                                    <div class="progress-box mt-0">
                                        <div class="d-flex justify-content-between">
                                ...
                                <div class="country-list">
                                    <img src="{{ getFileVersion('/assets/images/country/aus.png') }}" alt="">
                                    <div class="progress-box mt-0">
                                        <div class="d-flex justify-content-between">
                                ...
                                <div class="country-list">
                                    <img src="{{ getFileVersion('/assets/images/country/usa.png') }}" alt="">
                                    <div class="progress-box mt-0">
                                        <div class="d-flex justify-content-between">
                                ...
                                <div class="country-list">
                                    <img src="{{ getFileVersion('/assets/images/country/pak.png') }}" alt="">
                                    <div class="progress-box mt-0">
                                        <div class="d-flex justify-content-between">
                                ...
                                <div class="country-list">
                                    <img src="{{ getFileVersion('/assets/images/country/germany.png') }}" alt="">
                                    <div class="progress-box mt-0">
                                        <div class="d-flex justify-content-between">
                                ...
                                <div class="country-list">
                                    <img src="{{ getFileVersion('/assets/images/country/uae.png') }}" alt="">
                                    <div class="progress-box mt-0">
                                        <div class="d-flex justify-content-between">
                                ...
                                <div class="country-list">
                                    <img src="{{ getFileVersion('/assets/images/country/china.png') }}" alt="">
                                    <div class="progress-box mt-0">
                                        <div class="d-flex justify-content-between">
                    ...
                    <div class="chat-box-area style-1 dz-scroll" id="chartBox2">
                        <div class="media">
                            <div class="message-received w-auto">
                                <div class="d-flex">
                                    <img src="{{ getFileVersion('/assets/images/contacts/pic2.jpg') }}" class="avatar rounded-circle" alt="">
                                    <div class="ms-1 text">
                        ...
                        <table id="product-tbl" class="table ">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <div class="products">
                                            <img src="{{ getFileVersion('/assets/images/contacts/d1.jpg') }}" class="avatar avatar-md" alt="">
                                            <div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="products">
                                            <img src="{{ getFileVersion('/assets/images/contacts/d2.jpg') }}" class="avatar avatar-md" alt="">
                                            <div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="products">
                                            <img src="{{ getFileVersion('/assets/images/contacts/d3.jpg') }}" class="avatar avatar-md" alt="">
                                            <div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="products">
                                            <img src="{{ getFileVersion('/assets/images/contacts/d4.jpg') }}" class="avatar avatar-md" alt="">
                                            <div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="products">
                                            <img src="{{ getFileVersion('/assets/images/contacts/d5.jpg') }}" class="avatar avatar-md" alt="">
                                            <div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="products">
                                            <img src="{{ getFileVersion('/assets/images/contacts/d6.jpg') }}" class="avatar avatar-md" alt="">
                                            <div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="products">
                                            <img src="{{ getFileVersion('/assets/images/contacts/d7.jpg') }}" class="avatar avatar-md" alt="">
                                            <div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="products">
                                            <img src="{{ getFileVersion('/assets/images/contacts/d8.jpg') }}" class="avatar avatar-md" alt="">
                                            <div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="products">
                                            <img src="{{ getFileVersion('/assets/images/contacts/d14.jpg') }}" class="avatar avatar-md" alt="">
                                            <div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="products">
                                            <img src="{{ getFileVersion('/assets/images/contacts/d13.jpg') }}" class="avatar avatar-md" alt="">
                                            <div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="products">
                                            <img src="{{ getFileVersion('/assets/images/contacts/d9.jpg') }}" class="avatar avatar-md" alt="">
                                            <div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="products">
                                            <img src="{{ getFileVersion('/assets/images/contacts/d10.jpg') }}" class="avatar avatar-md" alt="">
                                            <div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="products">
                                            <img src="{{ getFileVersion('/assets/images/contacts/d11.jpg') }}" class="avatar avatar-md" alt="">
                                            <div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="products">
                                            <img src="{{ getFileVersion('/assets/images/contacts/d12.jpg') }}" class="avatar avatar-md" alt="">
                                            <div>
                        ...
                        <table id="empoloyees-tbl" class="table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <div class="products">
                                            <img src="{{ getFileVersion('/assets/images/contacts/pic1.jpg') }}" class="avatar avatar-md" alt="">
                                            <div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="products">
                                            <img src="{{ getFileVersion('/assets/images/contacts/pic2.jpg') }}" class="avatar avatar-md" alt="">
                                            <div>
                                                <h6><a href="javascript:void(0)">Ricky Antony</a></h6>
                                                <span>Web Designer</span>
                                            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="products">
                                            <img src="{{ getFileVersion('/assets/images/contacts/pic3.jpg') }}" class="avatar avatar-md" alt="">
                                            <div>
