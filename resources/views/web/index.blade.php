...
<div class="mb-n10 mb-lg-n20 z-index-2">
    ...
    <div class="container">
        ...
        <div class="text-center mb-17">
            ...
            <!--end::Title-->
            <!--begin::Text-->
            <div class="fs-5 text-muted fw-bold"> Welcome to TechBoostify: Your path to digital triumph. 🚀
    ...
    <div class="pb-15 pt-18 landing-dark-bg">
        ...
        <div class="container">
            ...
            <div class="fs-2 fw-semibold text-muted text-center">
                <a href="{{ route('admin.account.security.index') }}" class="link-primary fs-4 fw-bold">Marcus Levy,</a>
