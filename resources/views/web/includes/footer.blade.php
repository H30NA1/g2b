                ...
                <div class="col-lg-6 pe-lg-16 mb-10 mb-lg-0">
                    ...
                    <div class="rounded landing-dark-border p-9">
                        ...
                        <span class="fw-normal fs-4 text-gray-700">Use Our Custom Development Service.
                            <a href="{{ route('admin.pages.user-profile.overview') }}" class="text-white opacity-50 text-hover-primary">Click to Get a Quote</a></span>
                        <!--end::Text-->
                    </div>
                    <!--end::Block-->
                </div>
                    ...
                    <div class="d-flex justify-content-center">
                        ...
                        <div class="d-flex fw-semibold flex-column ms-lg-20">
                            ...
                            <a href="https://www.facebook.com/keenthemes" class="mb-6">
                                <img src="{{ getFileversion('/assets/web/media/svg/brand-logos/facebook-4.svg') }}" class="h-20px me-2" alt="" />
                                <span class="text-white opacity-50 text-hover-primary fs-5 mb-6">Facebook</span>
                            </a>
                            <!--end::Link-->
                            <!--begin::Link-->
                            <a href="https://github.com/KeenthemesHub" class="mb-6">
                                <img src="{{ getFileversion('/assets/web/media/svg/brand-logos/github.svg') }}" class="h-20px me-2" alt="" />
                                <span class="text-white opacity-50 text-hover-primary fs-5 mb-6">Github</span>
                            </a>
                            <!--end::Link-->
                            <!--begin::Link-->
                            <a href="https://twitter.com/keenthemes" class="mb-6">
                                <img src="{{ getFileversion('/assets/web/media/svg/brand-logos/twitter.svg') }}" class="h-20px me-2" alt="" />
                                <span class="text-white opacity-50 text-hover-primary fs-5 mb-6">Twitter</span>
                            </a>
                            <!--end::Link-->
                            <!--begin::Link-->
                            <a href="https://dribbble.com/keenthemes" class="mb-6">
                                <img src="{{ getFileversion('/assets/web/media/svg/brand-logos/dribbble-icon-1.svg') }}" class="h-20px me-2" alt="" />
                                <span class="text-white opacity-50 text-hover-primary fs-5 mb-6">Dribbble</span>
                            </a>
                            <!--end::Link-->
                            <!--begin::Link-->
                            <a href="https://www.instagram.com/keenthemes" class="mb-6">
                                <img src="{{ getFileversion('/assets/web/media/svg/brand-logos/instagram-2-1.svg') }}" class="h-20px me-2" alt="" />
            ...
            <div class="d-flex flex-column flex-md-row flex-stack py-7 py-lg-10">
                ...
                <div class="d-flex align-items-center order-2 order-md-1">
                    ...
                    <a href="{{ route('web.index') }}">
                        <img alt="Logo" src="{{ getFileversion('/assets/web/media/logos/landing.svg') }}" class="h-15px h-md-20px" />
                    </a>
                    <!--end::Logo image-->
                    <!--begin::Logo image-->
